...
describe("initRustCrypto", () => {
    ...
    describe("libolm migration", () => {
        it("migrates data from a legacy crypto store", async () => {
            ...
            expect(atob(data.crossSigningMasterKey!)).toEqual("master key");
            expect(atob(data.crossSigningUserSigningKey!)).toEqual("usk");
            expect(atob(data.crossSigningSelfSigningKey!)).toEqual("ssk");
